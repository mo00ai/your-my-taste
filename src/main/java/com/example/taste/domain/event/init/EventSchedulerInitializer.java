...
//
// 		// 게시글 3개 생성
// 		Board board1 = Board.nBoardBuilder()
// 			.requestDto(BoardRequestDto.builder()
// 				.title("1번의 김치찌개 맛집")
// 				.contents("진짜 맛있어요!")
// 				.type(null) // null이면 기본값 BoardType.N
// 				.status(null) // null이면 기본값 BoardStatus.OPEN
// 				.build())
// 			.store(store)
// 			.user(user1)
// 			.buildNormal();
...
//
// 		Board board2 = Board.nBoardBuilder()
// 			.requestDto(BoardRequestDto.builder()
// 				.title("2번의 김치찌개")
// 				.contents("우리 동네 최강!")
// 				.build())
...
//
// 		Board board3 = Board.nBoardBuilder()
// 			.requestDto(BoardRequestDto.builder()
// 				.title("3번 찌개도 괜찮음")
// 				.contents("무난한 맛집")
// 				.build())
