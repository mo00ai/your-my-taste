...
public class MatchController {
	...
	public CommonResponse<Void> updateUserMatchCond(
		...
		matchService.updateUserMatchCond(matchingConditionId, requestDto);
		return CommonResponse.ok();
	}

	@DeleteMapping("/match-conditions/{matchingConditionId}")
	public CommonResponse<Void> updateUserMatchCond(
		@AuthenticationPrincipal CustomUserDetails userDetails,
		@PathVariable Long matchingConditionId) {
		matchService.deleteUserMatchCond(matchingConditionId);
		return CommonResponse.ok();
	}
}
