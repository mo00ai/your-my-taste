...
public class ReviewController {
	...
	public CommonResponse<CreateReviewResponseDto> createReview(
		...
		return CommonResponse.created(
			reviewService.createReview(requestDto, storeId, files, ImageType.REVIEW, userDetails.getId()));
	}
	...
	public CommonResponse<UpdateReviewResponseDto> updateReview(
		...
		return CommonResponse.ok(
			reviewService.updateReview(requestDto, reviewId, files, ImageType.REVIEW, userDetails.getId()));
	}
	...
	public CommonResponse<Void> createValidation(@PathVariable Long storeId,
		...
		ocrService.createValidation(storeId, image, userDetails.getId());
		return CommonResponse.ok();
	}
}
