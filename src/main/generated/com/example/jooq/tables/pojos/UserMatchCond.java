...
public class UserMatchCond implements Serializable {
    ...
    private UserMatchCondGender gender;
    private UserMatchCondMatchingStatus matchingStatus;
    private String region;
    private Long userId;

    public UserMatchCond() {}

    public UserMatchCond(UserMatchCond value) {
        this.id = value.id;
    ...
    public UserMatchCond(
        ...
        Integer ageMaxRange,
        Integer ageMinRange,
        UserMatchCondGender gender,
        UserMatchCondMatchingStatus matchingStatus,
        String region,
        Long userId
    ) {
        this.id = id;
     ...
     */
    public void setGender(UserMatchCondGender gender) {
        this.gender = gender;
    }
     ...
     */
    public void setMatchingStatus(UserMatchCondMatchingStatus matchingStatus) {
        this.matchingStatus = matchingStatus;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final UserMatchCond other = (UserMatchCond) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("UserMatchCond (");
