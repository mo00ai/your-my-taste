...
public class BoardRecord extends UpdatableRecordImpl<BoardRecord> implements Record12<Long, LocalDateTime, LocalDateTime, LocalDateTime, String, Integer, LocalDateTime, BoardAccessPolicy, String, BoardType, Long, Long> {
    ...
    public BoardAccessPolicy getAccessPolicy() {
        return (BoardAccessPolicy) get(7);
    }
    ...
    @Override
    public Row12<Long, LocalDateTime, LocalDateTime, LocalDateTime, String, Integer, LocalDateTime, BoardAccessPolicy, String, BoardType, Long, Long> valuesRow() {
    ...
    @Override
    public Field<BoardAccessPolicy> field8() {
    ...
    @Override
    public BoardAccessPolicy component8() {
    ...
    @Override
    public BoardAccessPolicy value8() {
        return getAccessPolicy();
    }
    ...
    @Override
    public BoardRecord value8(BoardAccessPolicy value) {
    ...
    @Override
    public BoardRecord values(Long value1, LocalDateTime value2, LocalDateTime value3, LocalDateTime value4, String value5, Integer value6, LocalDateTime value7, BoardAccessPolicy value8, String value9, BoardType value10, Long value11, Long value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BoardRecord(Long id, LocalDateTime createdAt, LocalDateTime deletedAt, LocalDateTime updatedAt, String contents, Integer openLimit, LocalDateTime openTime, BoardAccessPolicy accessPolicy, String title, BoardType type, Long storeId, Long userId) {
        super(Board.BOARD);
