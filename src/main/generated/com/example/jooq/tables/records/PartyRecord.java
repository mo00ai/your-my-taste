...
public class PartyRecord extends UpdatableRecordImpl<PartyRecord> implements Record12<Long, LocalDateTime, String, Boolean, Integer, LocalDateTime, Integer, PartyPartyStatus, String, Long, Long, LocalDate> {
     ...
     */
    public void setMeetingTime(LocalDateTime value) {
        set(5, value);
    }
    ...
    @Override
    public Row12<Long, LocalDateTime, String, Boolean, Integer, LocalDateTime, Integer, PartyPartyStatus, String, Long, Long, LocalDate> valuesRow() {
    ...
    public Field<LocalDateTime> field6() {
        return Party.PARTY.MEETING_TIME;
    }
    ...
    @Override
    public PartyRecord value12(LocalDate value) {
        setMeetingDate(value);
        return this;
    }

    @Override
    public PartyRecord values(Long value1, LocalDateTime value2, String value3, Boolean value4, Integer value5, LocalDateTime value6, Integer value7, PartyPartyStatus value8, String value9, Long value10, Long value11, LocalDate value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PartyRecord(Long id, LocalDateTime createdAt, String description, Boolean enableRandomMatching, Integer maxMembers, LocalDateTime meetingTime, Integer nowMembers, PartyPartyStatus partyStatus, String title, Long userId, Long storeId, LocalDate meetingDate) {
        super(Party.PARTY);
    ...
    public PartyRecord(com.example.jooq.tables.pojos.Party value) {
        ...
        if (value != null) {
            ...
            setMeetingTime(value.getMeetingTime());
