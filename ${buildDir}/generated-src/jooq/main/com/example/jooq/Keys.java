...
public class Keys {
    ...
    public static final UniqueKey<PartyMatchInfoFavorRecord> KEY_PARTY_MATCH_INFO_FAVOR_PRIMARY = Internal.createUniqueKey(PartyMatchInfoFavor.PARTY_MATCH_INFO_FAVOR, DSL.name("KEY_party_match_info_favor_PRIMARY"), new TableField[] { PartyMatchInfoFavor.PARTY_MATCH_INFO_FAVOR.ID }, true);
    ...
    public static final UniqueKey<UserMatchInfoFavorRecord> KEY_USER_MATCH_INFO_FAVOR_PRIMARY = Internal.createUniqueKey(UserMatchInfoFavor.USER_MATCH_INFO_FAVOR, DSL.name("KEY_user_match_info_favor_PRIMARY"), new TableField[] { UserMatchInfoFavor.USER_MATCH_INFO_FAVOR.ID }, true);
    ...
    public static final ForeignKey<PartyMatchInfoFavorRecord, FavorRecord> FKDF8KUMDJNHB66XT3CYDK53OM1 = Internal.createForeignKey(PartyMatchInfoFavor.PARTY_MATCH_INFO_FAVOR, DSL.name("FKdf8kumdjnhb66xt3cydk53om1"), new TableField[] { PartyMatchInfoFavor.PARTY_MATCH_INFO_FAVOR.FAVOR_ID }, Keys.KEY_FAVOR_PRIMARY, new TableField[] { Favor.FAVOR.ID }, true);
    public static final ForeignKey<PartyMatchInfoFavorRecord, PartyMatchInfoRecord> FKJMDMOV29XRFUWX20HIDPP2322 = Internal.createForeignKey(PartyMatchInfoFavor.PARTY_MATCH_INFO_FAVOR, DSL.name("FKjmdmov29xrfuwx20hidpp2322"), new TableField[] { PartyMatchInfoFavor.PARTY_MATCH_INFO_FAVOR.PARTY_MATCH_INFO_ID }, Keys.KEY_PARTY_MATCH_INFO_PRIMARY, new TableField[] { PartyMatchInfo.PARTY_MATCH_INFO.ID }, true);
    ...
    public static final ForeignKey<UserMatchInfoFavorRecord, UserMatchInfoRecord> FK65KV7X2GBSN9GCPVEU8W3R2EF = Internal.createForeignKey(UserMatchInfoFavor.USER_MATCH_INFO_FAVOR, DSL.name("FK65kv7x2gbsn9gcpveu8w3r2ef"), new TableField[] { UserMatchInfoFavor.USER_MATCH_INFO_FAVOR.USER_MATCH_INFO_ID }, Keys.KEY_USER_MATCH_INFO_PRIMARY, new TableField[] { UserMatchInfo.USER_MATCH_INFO.ID }, true);
    public static final ForeignKey<UserMatchInfoFavorRecord, FavorRecord> FK6E89K6DJLSH8YB4F40DEFIJP6 = Internal.createForeignKey(UserMatchInfoFavor.USER_MATCH_INFO_FAVOR, DSL.name("FK6e89k6djlsh8yb4f40defijp6"), new TableField[] { UserMatchInfoFavor.USER_MATCH_INFO_FAVOR.FAVOR_ID }, Keys.KEY_FAVOR_PRIMARY, new TableField[] { Favor.FAVOR.ID }, true);
