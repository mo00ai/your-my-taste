...
public class PartyDao extends DAOImpl<PartyRecord, com.example.jooq.tables.pojos.Party, Long> {
    ...
    /**
     * Fetch records that have <code>meeting_time BETWEEN lowerInclusive AND
     * upperInclusive</code>
     */
    public List<com.example.jooq.tables.pojos.Party> fetchRangeOfMeetingTime(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
        return fetchRange(Party.PARTY.MEETING_TIME, lowerInclusive, upperInclusive);
    }

    /**
     * Fetch records that have <code>meeting_time IN (values)</code>
     */
    public List<com.example.jooq.tables.pojos.Party> fetchByMeetingTime(LocalDateTime... values) {
        return fetch(Party.PARTY.MEETING_TIME, values);
    }
