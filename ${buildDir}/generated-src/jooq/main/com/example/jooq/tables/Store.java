...
public class Store extends TableImpl<StoreRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function11<? super Long, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super String, ? super String, ? super BigDecimal, ? super BigDecimal, ? super String, ? super String, ? super Long, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function11<? super Long, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super String, ? super String, ? super BigDecimal, ? super BigDecimal, ? super String, ? super String, ? super Long, ? extends U> from) {
