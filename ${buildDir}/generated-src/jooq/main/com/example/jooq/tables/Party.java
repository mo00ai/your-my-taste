...
public class Party extends TableImpl<PartyRecord> {
     ...
     */
    public final TableField<PartyRecord, PartyPartyStatus> PARTY_STATUS = createField(DSL.name("party_status"), SQLDataType.VARCHAR(7).nullable(false).asEnumDataType(com.example.jooq.enums.PartyPartyStatus.class), this, "");
     ...
     */
    public final TableField<PartyRecord, Long> STORE_ID = createField(DSL.name("store_id"), SQLDataType.BIGINT, this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function11<? super Long, ? super LocalDateTime, ? super String, ? super Boolean, ? super Integer, ? super LocalDate, ? super Integer, ? super PartyPartyStatus, ? super String, ? super Long, ? super Long, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function11<? super Long, ? super LocalDateTime, ? super String, ? super Boolean, ? super Integer, ? super LocalDate, ? super Integer, ? super PartyPartyStatus, ? super String, ? super Long, ? super Long, ? extends U> from) {
