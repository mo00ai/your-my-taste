...
(
    ...
    min_age      integer,
    gender       varchar(255)
        constraint party_match_info_gender_check
            check ((gender)::text = ANY
                   ((ARRAY ['ANY'::character varying, 'FEMALE'::character varying, 'MALE'::character varying])::text[])),
    match_status varchar(255)
        constraint party_match_info_match_status_check
...
(
    ...
    endpoint        varchar(1000)
        constraint ukj7djxr6u5ms5utbqhb5arh5wt
            unique,
...
create table user_notification_deny_setting
(
    id                    bigint generated by default as identity
        primary key,
    created_at            timestamp(6),
...
alter table user_notification_deny_setting
    owner to postgres;
